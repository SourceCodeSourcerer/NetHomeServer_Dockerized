...
echo "  From: $SRCROOT" 1>&2
echo "  TO  : $INSTALLATION_ROOT" 1>&2
cp -r $SRCROOT $INSTALLATION_ROOT
chown -R $NH_USER $INSTALLATION_ROOT
rm -f $INSTALLATION_ROOT/lib/librxtxSerial_x86_64.so
cp $INSTALLATION_ROOT/os/librxtxSerial_x86_64.so $INSTALLATION_ROOT/lib/librxtxSerial_x86_64.so
